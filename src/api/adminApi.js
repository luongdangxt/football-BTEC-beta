...
const adminApi = {
  createMatch(matchData) {
    // Gửi thẳng chuỗi ngày và giờ lên server
    const payload = {
  ...
  lockMatch(matchId) { return axiosClient.put(`/api/matches/${matchId}/lock`); },
  updateScore(matchId, a, b) { return axiosClient.put(`/api/matches/${matchId}/score`, {score_a: a, score_b: b}); }
};
